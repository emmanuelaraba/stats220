...
Next, we can visualise how the 'fullness' of presentations affects how well received the presentation was, and ultimately if the audience liked it enough to clap.
```{r}
...
```
Likewise, if I observed more engagement in lectures, by grouping the various categories of engagement into one category, called 'some engagement' and having  another category called 'no engagement'. Then, we could find out if the audiences that had some engagement with the presentation were more likely to clap for their presenter.
```{r}
